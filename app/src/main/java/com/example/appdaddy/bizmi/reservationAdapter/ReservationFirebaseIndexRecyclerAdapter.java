 ...
 *     }
 *
 *     ReservationFirebaseIndexRecyclerAdapter<ChatMessage, ChatMessageViewHolder> adapter;
 ...
 *
 *     adapter = new ReservationFirebaseIndexRecyclerAdapter<ChatMessage, ChatMessageViewHolder>(
 ...
 */
public abstract class ReservationFirebaseIndexRecyclerAdapter<T, VH extends RecyclerView.ViewHolder>
        extends ReservationFirebaseRecyclerAdapter<T, VH> {
    /**
     ...
     */
    public ReservationFirebaseIndexRecyclerAdapter(Class<T> modelClass,
                                                   @LayoutRes int modelLayout,
                                                   Class<VH> viewHolderClass,
                                                   Query keyRef,
                                                   Query dataRef,
                                                   Query thirdDataRef) {
        super(modelClass, modelLayout, viewHolderClass, new ReservationFirebaseIndexArray(keyRef, dataRef, thirdDataRef));
    }
}
