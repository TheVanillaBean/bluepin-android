...
import com.bluepinapp.bluepin.Fragments.ViewWebsiteFragment;
import com.bluepinapp.bluepin.POJO.RetrieveSubscriptionStatusEvent;
import com.bluepinapp.bluepin.R;
import com.bluepinapp.bluepin.ViewBusinessDirectionsFragment;
...
public class BusinessInfoDialog extends DialogFragment implements OnMapReadyCallback {
    ...
    public void onHoursBtnPressed() {
        com.bluepinapp.bluepin.util.Dialog.showDialog(getActivity(),"Business Hours", mBusinessUser.getBusinessHours(), "Okay");
    }
