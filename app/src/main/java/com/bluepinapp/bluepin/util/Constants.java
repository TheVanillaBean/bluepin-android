...
public class Constants {
    ...
    public static final String EXTRA_CHATTING_WITH = "chattingWith";
    public static final String EXTRA_CHATTING_WITH_ID = "chattingWithID";
    ...
    public static final String MESSAGE_TIMESTAMP_FORMATTED = "timeStampFormatted";
    ...
    public static final String MESSAGE_NOTIF = "MessageDialog";
